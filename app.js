  ...
  var QUESTIONS = [
    {
      ...
      options: [
        ...
        { label: '🌈 радуга', sentence: 'Ты сегодня как радуга.' },
        { label: '⛈️ гроза', sentence: 'Ты сегодня как гроза.' },
        { label: '🌫️ туман', sentence: 'Ты сегодня как туман.' },
        { label: '✍️ свой вариант', custom: true, placeholder: 'напиши, какая погода…', maxlen: 60 }
      ]
    },
    {
      id: 'inner',
      ...
      options: [
        ...
        { label: '🫥 пустота' },
        { label: '😴 сонливость' },
        { label: '✍️ свой вариант', custom: true, placeholder: 'напиши, что внутри…', maxlen: 60 }
      ]
    },
    {
      id: 'body',
      ...
      options: [
        ...
        { label: '🫧 вяло' },
        { label: '🤒 не очень' },
        { label: '✍️ свой вариант', custom: true, placeholder: 'напиши, как тело…', maxlen: 60 }
      ]
    },
    {
      id: 'remove',
    ...
    },
    {
      ...
      options: [
        ...
        { label: '✍️ свой вариант', custom: true, placeholder: 'напиши, сколько сил…', maxlen: 60 }
      ]
    },
    {
      id: 'good',
    ...
    },
    {
      ...
      options: [
        ...
        { label: '🛌 поспать' },
        { label: '📱 тик ток' },
        { label: '✍️ свой вариант', custom: true, placeholder: 'напиши, чего хочется…', maxlen: 60 }
      ]
    },
    {
      id: 'wish',
      ...
      options: [
        ...
        { label: '✍️ свой вариант', custom: true, placeholder: 'напиши, чего хочешь…', maxlen: 60 }
      ]
    },
    {
      id: 'help',
      ...
      options: [
        ...
        { label: '🍬 вкусняшки', sentence: 'Хочешь вкусняшку.' },
        { label: '🕐 время', sentence: 'Хочешь, чтобы тебе дали время.' },
        { label: '🚪 ничего, спасибо', sentence: 'Сейчас тебе ничего не нужно.' },
        { label: '✍️ свой вариант', custom: true, placeholder: 'напиши, что поможет…', maxlen: 60 }
      ]
    },
    {
      id: 'need',
    ...
    {
      id: 'nick',
      block: 'Блок 4 · Для тебя',
      title: 'как бы ты меня сейчас назвал(а)?',
      options: [
        { label: '🤪 дурачьё' },
        { label: '🥰 милаш' },
        { label: '🐦 кукушка' },
        { label: '🐍 змеюка' },
        { label: '✍️ свой вариант', custom: true, placeholder: 'напиши, как бы назвал(а)…', maxlen: 60 }
      ]
    },
    {
      id: 'do',
      block: 'Блок 4 · Для тебя',
      title: 'что бы ты сделал(а), будь я рядом?',
      options: [
        { label: '🪑 треснул(а) табуреткой' },
        { label: '🦷 укусил(а)' },
        { label: '🤗 обнял(а)' },
        { label: '💆 погладил(а)' },
        { label: '🍜 накормил(а)' },
        { label: '✍️ свой вариант', custom: true, placeholder: 'напиши, что бы сделал(а)…', maxlen: 60 }
      ]
    }
  ];
